...
\begin{cventries}
  ...
  \cventry
    ...
    {2021 -- 2022}
    {
      ...
      \begin{cvitems}
        \item[>>] Supervisor: Jun Luo
        \item[>>] Supervised two software developer interns who worked on a simulator for unprotected left turns for robust agents~(ULTRA). Designed an evaluation methodology for generalization of reinforcement learning agents.
      \end{cvitems}
    }
