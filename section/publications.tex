...
\begin{cventries}
    ...
    {04/2026}
    {
      \vspace{-4.0mm}
      \begin{cvitems}
        \item[>>]  A. A. Ramesh, \textbf{A. Lewandowski}, J. Schmidhuber
    	\item[>>] Preprint
      \end{cvitems}
    }
    ...
    {12/2025}
    {
      \vspace{-4.0mm}
      \begin{cvitems}
        \item[>>] G. S. Baveja, \textbf{A. Lewandowski}, M. Schmidt
    	\item[>>] Workshop on Optimization for Machine Learning at NeurIPS
      \end{cvitems}
    }
    ...
    {04/2025}
    {
      \vspace{-4.0mm}
      \begin{cvitems}
        \item[>>] \textbf{A. Lewandowski}, M. Bortkiewicz, S. Kumar, A. György, D. Schuurmans, M. Ostaszewski, M. C. Machado
    	\item[>>] International Conference on Learning Representations \textbf{(ICLR)}
      \end{cvitems}
    }
    ...
    {08/2024}
    {
      ...
      \begin{cvitems}
    	...
    	\item[>>] Finding The Frame Workshop at RLC \textbf{(RLC workshop oral)}
      \end{cvitems}
    }
    ...
    {12/2020}
    {
      ...
      \begin{cvitems}
    	...
    	\item[>>] Beyond Backpropagation Workshop at NeurIPS \textbf{(NeurIPS workshop oral)}
      \end{cvitems}
    }
